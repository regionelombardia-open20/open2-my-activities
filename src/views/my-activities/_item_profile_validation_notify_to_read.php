...
$userStatus = $model->status === UserProfileValidationNotify::STATUS_ACTIVE
    ? Amosadmin::t('amosadmin', 'Profilo validato')
    : Amosadmin::t('amosadmin', 'Profilo rifiutato')
;
?>
<div class="wrap-activity">
    ...
    <?= Html::a(
        ...
        Yii::$app->urlManager->createUrl([
            ...
            . '/user-profile/read-confirmation',
            'id' => $model->id,
            'uid' => $user_id
        ]),
        [
